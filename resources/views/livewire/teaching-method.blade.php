            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime-style-2" data-cursor="-opaque">Méthode <span>Pédagogique</span></h1>
                        <nav class="wow fadeInUp">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('home') }}">Accueil</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Méthode Pédagogique</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Page Header Box End -->
                        ...
                        <div class="about-us-body wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            <div class="about-us-body-item">
                                ...
                                <div class="about-body-item-content">
                                    ...
                                    <p>Une prise en main immédiate avec un maximum de plaisir et de sécurité.</p>
                                </div>
                            </div>
                            <!-- About Us Body Item End -->
                        </div>
                    ...
                    <div class="our-benefit-content">
                        ...
                        <div class="faq-accordion" id="benefit_accordion">
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.6s">
                                <h2 class="accordion-header" id="benefit_heading4">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#benefit_collapse4" aria-expanded="false"
                                            aria-controls="benefit_collapse4">
                                        Risques de chutes fréquentes ?
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item wow fadeInUp" data-wow-delay="0.8s">
                                <h2 class="accordion-header" id="benefit_heading5">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#benefit_collapse5" aria-expanded="false"
                                            aria-controls="benefit_collapse5">
                                        Crispations du cavalier ?
                                    </button>
                                </h2>
